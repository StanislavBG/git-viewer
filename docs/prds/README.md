...
| 04  | Achievements / trophies row                | 2 | spec only |
| 05  | Per-project file treemap                   | 2 | spec only |
| 06  | Cross-repo activity feed (PRs/issues/releases) | 2 | spec only |
| 07  | Productive-time 7×24 heatmap               | 1 | implemented |
| 08  | Resume / print mode                        | 1 | implemented |

Tier-1 PRDs are landed in v3.0; tier-2 PRDs are scoped and waiting on
prioritization for v3.1.
